================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : CMailDemo3 プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した CMailDemo3 には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには CMailDemo3 アプリケーションを構成している各ファイルの概要説明が含
    まれています。
...
CMailDemo3.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CCMailDemo3App アプリケーション クラス
    の宣言をします。

CMailDemo3.cpp
    このファイルは CCMailDemo3App アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\CMailDemo3.ico
    ...
    リソース ファイル CMailDemo3.rc によってインクルードされます。
...
CMailDemo3Dlg.h, CMailDemo3Dlg.cpp - the dialog
    Tこれらのファイルは CCMailDemo3Dlg クラスを含みます。このクラスはアプリケーションの 
    メイン ダイアログの動作を定義します。ダイアログ テンプレートは Microsoft Visual C++ で編集 
    可能な CMailDemo3.rc に含まれます。
/////////////////////////////////////////////////////////////////////////////

その他の標準ファイル :

StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) CMailDemo3.pch や既にコン 
