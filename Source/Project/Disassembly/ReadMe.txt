========================================================================
		ActiveX Control DLL : DISASSEMBLY
========================================================================

ControlWizard has created this project for your DISASSEMBLY ActiveX Control
...
that make up your DISASSEMBLY ActiveX Control DLL.
...
DisassemblyCtl.h
	This file contains the declaration of the CDisassemblyCtrl C++ class.

DisassemblyCtl.cpp
	This file contains the implementation of the CDisassemblyCtrl C++ class.

DisassemblyPpg.h
	This file contains the declaration of the CDisassemblyPropPage C++ class.

DisassemblyPpg.cpp
	This file contains the implementation of the CDisassemblyPropPage C++ class.

DisassemblyCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CDisassemblyCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Disassembly.rc.
